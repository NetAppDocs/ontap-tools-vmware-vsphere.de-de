...
NOTE: Diese vCenter Server Berechtigungen gelten für ONTAP Tools vCenter Benutzer, nicht für VSC Administratoren. Standardmäßig haben VSC-Administratoren vollständigen Zugriff auf das Produkt und benötigen keine ihnen zugewiesenen Berechtigungen.
